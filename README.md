...
| [#240](https://github.com/griffinmartin/opencode-claude-auth/pull/240)                                                                          | Applied manually                   | Only the Claude CLI compatibility header update is ported: `ccVersion` bumped to `2.1.185` and three new base betas added (`thinking-token-count-2026-05-13`, `extended-cache-ttl-2025-04-11`, `effort-2025-11-24`). This fork intentionally keeps 1M context opt-in rather than adopting any related default-on behavior from #240. |
